# --- agentskill.sh ---
# slug: openclaw/humanizer-2
# owner: openclaw
# contentSha: 020cb8f
# installed: 2026-03-19T01:19:23.732Z
# source: https://agentskill.sh/openclaw/humanizer-2
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback openclaw/humanizer-2 <1-5> [optional comment]
